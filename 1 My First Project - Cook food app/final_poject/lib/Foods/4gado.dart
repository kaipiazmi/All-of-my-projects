...
Future<Album> fetchAlbum() async {
  final response = await http
      .get(Uri.parse('https://636dfddc182793016f32d807.mockapi.io/foods/4'));
...
class GadoGado extends StatefulWidget {
  const GadoGado({super.key});

  @override
  State<GadoGado> createState() => _GadoGadoState();
}

class _GadoGadoState extends State<GadoGado> {
