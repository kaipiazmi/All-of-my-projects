...
Future<Album> fetchAlbum() async {
  final response = await http
      .get(Uri.parse('https://636dfddc182793016f32d807.mockapi.io/foods/3'));
...
Widget BuildKembali() => Container(
  ...
  Widget build(BuildContext context) {
    ...
    Text(
      ...
      "  Bahan-Bahan :", style: TextStyle(fontSize:25, fontWeight: FontWeight.w600), ),   
    const SizedBox(height: 5),
    
    BuildKomposisi(),
    const SizedBox(height: 10),
     Text(
      "  Cara Pembuatan :", style: TextStyle(fontSize:25, fontWeight: FontWeight.w600), ),   
    const SizedBox(height: 5),
    BuildPembuatan(),
